...
@Autonomous(name="CompBRed")
public class CompBRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        leftHex.setTargetPosition(-368);
        rightHex.setTargetPosition(-368);
        leftHex.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
        rightHex.setMode(DcMotorEx.RunMode.RUN_TO_POSITION);
        rightHex.setVelocity(220);
        leftHex.setVelocity(220);
